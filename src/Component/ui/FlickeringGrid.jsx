...
/**
 * Canvas grid of squares that randomly flicker in opacity.
 * Resolves `--foreground` so it follows the active theme, and only animates
 * while scrolled into view.
 */
export function FlickeringGrid({
  ...
  // Re-resolve the color when the `dark` class is toggled on <html>.
  useEffect(() => {
